...
export default function RegisterPage() {
  ...
  return (
    <main className="min-h-screen w-full flex items-center justify-center p-4 sm:p-6 lg:p-6 font-sans bg-background text-foreground">
      <div className="w-full max-w-[1220px] bg-card text-foreground border border-slate-100 dark:border-white/10 rounded-[22px] sm:rounded-[28px] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.07)] overflow-hidden p-2.5 sm:p-4 flex flex-col lg:flex-row-reverse lg:min-h-[640px]">
