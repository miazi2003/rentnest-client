      ...
      <Card className="rounded-3xl border-border shadow-xl overflow-hidden bg-card text-card-foreground">
        ...
        <CardHeader className="bg-rose-500/10 border-b border-rose-500/20 text-center pb-6 pt-8">
          ...
          <CardDescription className="text-xs text-rose-700 dark:text-rose-300 font-medium max-w-xs mx-auto mt-1">
            You cancelled the Stripe checkout session before completing the payment. No charges were deducted from your account.
          </CardDescription>
        </CardHeader>

        <CardContent className="p-6 space-y-4 text-center">
          <p className="text-xs text-muted-foreground leading-relaxed">
            If you experienced an issue during checkout or wish to select another payment method, you can retry payment anytime from your approved rental requests.
          </p>
        </CardContent>
        ...
        <CardFooter className="bg-muted/30 p-6 border-t border-border flex flex-col gap-3">
          <Link href="/dashboard/tenant/requests" className="w-full">
            <Button
              className="w-full rounded-2xl text-xs gap-2 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 shadow-md shadow-blue-500/20"
            >
