...
export function HomeNavbar() {
  ...
  return (
    <header className={`${isHome ? "absolute bg-transparent text-white border-none" : "sticky bg-background text-foreground border-b border-border/60 shadow-xs"} inset-x-0 top-0 z-50 transition-colors`}>
      <div className="mx-auto flex h-20 max-w-[1600px] items-center justify-between px-5 sm:px-8 lg:h-24 lg:px-12">
        ...
        <div className="flex items-center gap-2">
          ...
          <ThemeToggle variant={isHome ? "outline" : "ghost"} className={isHome ? "border-white/35 bg-black/10 text-white hover:bg-white/20" : ""} />
